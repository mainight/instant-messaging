...
import net.guikai.italker.factory.interfac.LoggingInterceptorLog;
...
public class Network {
    ...
    public static OkHttpClient getClicent() {
        ...
        HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor(new LoggingInterceptorLog());
